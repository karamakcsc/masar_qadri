...
# # NOTE: barcode imports are intentionally inside functions below.
# # Top-level imports cause install failures on Frappe Cloud when
# # python-barcode is not yet available during DocType sync.
